    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('users', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='users_cooworking', to=settings.AUTH_USER_MODEL, verbose_name='Пользователи')),
            ],
            options={
